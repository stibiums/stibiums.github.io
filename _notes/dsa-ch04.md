...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/notes_img/dsa-ch04/string_basic_concept.png" title="字符串基本概念示意图" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/notes_img/dsa-ch04/naive_matching_example.png" title="朴素匹配算法示例" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/notes_img/dsa-ch04/kmp_idea.png" title="KMP算法核心思想" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
